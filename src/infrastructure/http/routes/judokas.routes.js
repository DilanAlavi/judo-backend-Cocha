...
const { listar, listarSinClub, listarPorClub, obtener, obtenerPorUsuario, actualizarDatos, desactivar, cambiarClub,listarHistorial } = require('../controllers/judokas.controller')
