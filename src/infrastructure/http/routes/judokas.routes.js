...
const { listar, listarSinClub, listarPorClub, misEstudiantes, obtener, obtenerPorUsuario, actualizarDatos, desactivar, cambiarClub,listarHistorial } = require('../controllers/judokas.controller')
const authMiddleware = require('../middlewares/auth.middleware')
const rolesMiddleware = require('../middlewares/roles.middleware')

router.use(authMiddleware)
router.get('/', rolesMiddleware(['admin', 'asociacion', 'sensei']), listar)
router.get('/mis-estudiantes', rolesMiddleware(['sensei']), misEstudiantes)
router.get('/sin-club', rolesMiddleware(['admin', 'asociacion', 'sensei']), listarSinClub)
router.get('/historial', rolesMiddleware(['admin', 'asociacion', 'sensei']), listarHistorial)
